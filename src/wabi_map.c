...
wabi_map_builtins(const wabi_vm vm, const wabi_env env)
{
  ...
  /* if(vm->ert) return NULL; */
  /* wabi_defn(vm, env, "map-keys", wabi_map_builtin_map_keys); */
  /* if(vm->ert) return NULL; */
  /* wabi_defn(vm, env, "map-values", wabi_map_builtin_map_values); */
  /* if(vm->ert) return NULL; */
  /* wabi_defn(vm, env, "map-take", wabi_map_builtin_map_take); */
  /* if(vm->ert) return NULL; */
}
