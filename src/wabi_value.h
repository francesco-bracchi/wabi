...
typedef enum wabi_tag_enum {
  ...
  wabi_tag_bin_leaf   = 0x6000000000000000,
  wabi_tag_bin_node   = 0x7000000000000000,

  wabi_tag_map_array  = 0x8000000000000000,
  wabi_tag_map_entry  = 0x9000000000000000,
  wabi_tag_map_hash   = 0xa000000000000000,

  wabi_tag_oper       = 0xb000000000000000,
  wabi_tag_app        = 0xc000000000000000,
  wabi_tag_bt_oper    = 0xd000000000000000,
  wabi_tag_bt_app     = 0xe800000000000000,

  wabi_tag_env        = 0xf000000000000000,
  wabi_tag_var        = 0x0800000000000000,
  wabi_tag_cont_eval  = 0x1800000000000000,
  wabi_tag_cont_apply = 0x2800000000000000,
} wabi_tag;
...
static const wabi_word wabi_val_zero   = 0x1000000000000000;
