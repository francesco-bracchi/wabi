...
#define WABI_TYPE_NIL        0x0000000000000000
#define WABI_TYPE_BOOL       0x1000000000000000
#define WABI_TYPE_IGNORE     0x2000000000000000
#define WABI_TYPE_SMALLINT   0x3000000000000000
#define WABI_TYPE_FORWARD    0x4000000000000000
#define WABI_TYPE_SYMBOL     0x5000000000000000
#define WABI_TYPE_PAIR       0x6000000000000000
#define WABI_TYPE_BINARY     0x7000000000000000
#define WABI_TYPE_MAP        0x8000000000000000
#define WABI_TYPE_COMBINER   0x9000000000000000
#define WABI_TYPE_ENV        0xA000000000000000
#define WABI_TYPE_VAR        0xB000000000000000

#define WABI_TAG_NIL         0x0000000000000000
#define WABI_TAG_BOOL        0x1000000000000000
#define WABI_TAG_IGNORE      0x2000000000000000
#define WABI_TAG_SMALLINT    0x3000000000000000
#define WABI_TAG_FORWARD     0x4000000000000000
#define WABI_TAG_SYMBOL      0x5000000000000000
#define WABI_TAG_PAIR        0x6000000000000000
...
#define WABI_TAG_OPERATIVE   0x9000000000000000 // 0000
#define WABI_TAG_APPLICATIVE 0x9100000000000000 // 0001
#define WABI_TAG_BUILTIN_OP  0x9200000000000000 // 0010
#define WABI_TAG_BUILTIN_APP 0x9300000000000000 ///0011


#define WABI_TAG_ENV         0xA000000000000000

#define WABI_TAG_VAR         0xB000000000000000
