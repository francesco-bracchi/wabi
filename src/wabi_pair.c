...
/*     l1 = wabi_cdr((wabi_pair) l); */
/*     l1 = wabi_pair_concat(vm, l, r); */
/*     if(vm->ert) return NULL; */
/*     return (wabi_val) wabi_cons(vm, c, l1); */
/*   } */
/*   return r; */
/* } */
...
static void
wabi_pair_pair_car(const wabi_vm vm)
{
  wabi_val ctrl, pair;
  ctrl = vm->ctrl;
...
static void
wabi_pair_pair_cdr(const wabi_vm vm)
{
  wabi_val ctrl, pair;
  ctrl = vm->ctrl;
...
static void
wabi_pair_pair_cons(const wabi_vm vm)
{
...
static void
wabi_pair_pair_p(const wabi_vm vm)
{
